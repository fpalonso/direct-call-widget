...
import dev.ferp.dcw.data.picture.di.WidgetPicture
...
internal class BitmapLoader @Inject constructor(
    @WidgetPicture private val glideRequestBuilder: RequestBuilder<Bitmap>,
    @WidgetPicture private val diskCacheStrategy: DiskCacheStrategy = DiskCacheStrategy.NONE
) : PictureLoader {
    ...
    override suspend fun loadPicture(
        ...
        heightPx: Int,
        placeholderId: Int
    ): Result<Bitmap> = suspendCoroutine { continuation ->
        glideRequestBuilder
            .centerCrop()
    ...
    class ContinuationRequestListener(
        private val continuation: Continuation<Result<Bitmap>>
