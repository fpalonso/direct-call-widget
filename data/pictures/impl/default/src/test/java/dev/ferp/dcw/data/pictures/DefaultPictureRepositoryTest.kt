...
class DefaultPictureRepositoryTest {
    ...
    private lateinit var repo: DefaultPictureRepository
    ...
    fun `addPicture copies file from uri to pictures dir`() = runTest {
        ...
        // When
        val addPictureResult = repo.addPicture(sourceImage.fileUri.toString())
    ...
    fun `getPicture returns the right picture`() = runTest {
        ...
        // When
        val getPictureResult = repo.getPicture("fakeUri", 200, 200)
